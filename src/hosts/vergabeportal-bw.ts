...
export async function handleVergabeportalBw(page: any, url: string): Promise<Map<string, Buffer>> {
    const documents = new Map<string, Buffer>();
    
    try {
        console.log('Detected Vergabeportal Baden-Württemberg - applying special handling...');
        ...
        console.log('Special Vergabeportal Baden-Württemberg handling failed:', error);
    }
